...
- Image quality and assets: the assistant uses an original purple translation-bubble icon. The official Antigravity logo, glow, and extracted application icon were intentionally removed to avoid brand confusion and intellectual-property risk.
